...
//    @objc optional func playUrl(_ x: Any!) // Play specified URL.
//    @objc optional func addUrl(_ x: Any!) // Add specified URL to playlist
...
//    @objc optional var tiffArtworkData: Int { get } // Current track artwork data in TIFF format.
//    @objc optional var artworkImage: Int { get } // Current track artwork as an image.
    @objc optional var playerState: Int { get } // Player state (playing = 1, paused = 0)
//    @objc optional var track: Int { get } // Current track title.
//    @objc optional var trackUrl: Int { get } // Current track URL.
//    @objc optional var artist: Int { get } // Current track artist.
//    @objc optional var albumArtist: Int { get } // Current track album artist.
//    @objc optional var album: Int { get } // Current track album.
//    @objc optional var uniqueID: Int { get } // Unique identifier for the current track.
